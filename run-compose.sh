...
usage() {
    ...
    echo "  --webui[port=PORT]         Set the port for the web user interface (accessible on local network)."
    ...
    echo "  $0 --enable-gpu[count=1] --enable-api[port=12345] --webui[port=3000] (accessible on local network)"
